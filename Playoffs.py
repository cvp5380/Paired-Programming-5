...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        self.wait_for_row_in_list_table('2: Boston Celtics vs Indiana Pacers')
        self.wait_for_row_in_list_table('1: Philadelphia 76ers vs Brooklyn Nets')
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        self.assertNotIn('Philadelphia 76ers vs Brooklyn Nets', page_text)
        self.assertNotIn('Boston Celtics vs Indiana Pacers', page_text)
